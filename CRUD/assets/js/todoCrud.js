  ...
  try {
    ...
    if (empleadoDoc.exists()) {
      ...
      ulDetalleEmpleado.innerHTML = ` 
        <li class="list-group-item"><b>Empresa:</b> 
          ${nombre ? nombre : "No disponible"}
        </li>
        <li class="list-group-item"><b>Años requeridos:</b> 
        ...
        <li class="list-group-item"><b>Ubicacion:</b> ${telefono ? telefono : "No disponible"}</li>
